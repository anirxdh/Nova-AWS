...
- [x] **BACK-03**: POST /task endpoint — receives command + screenshot + DOM snapshot, calls Nova 2 Lite, returns answer or structured action steps
...
- [x] **NOVA-02**: Nova Sonic STT streaming mode (stretch goal if time permits)
...
- [x] **ENH-02**: Intelligence boost — viewport-aware DOM scraping with bounding boxes, chain-of-thought reasoning in prompts, reasoning display in bubble UI, action history compression for long chains
